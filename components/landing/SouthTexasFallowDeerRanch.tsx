...
const SouthTexasFallowDeerRanch: React.FC = () => {
  return (
    <LandingPageTemplate
      ...
      subtitle="CR Fallow — Floresville, Texas"
      heroImage="/images/hero-bg.jpg"
      intro="CR Fallow is a South Texas fallow operation located in Floresville, Texas, focused on consistent chocolate genetics and dependable herd development. We raise our deer with close attention to health, temperament, and long-term quality in the heart of South Texas ranch country."
      bulletPoints={[
