...
const FallowDeerBreedingStockTexas: React.FC = () => {
  return (
    <LandingPageTemplate
      ...
      intro="Building or expanding a fallow deer breeding program? Chital Ranch provides quality breeding stock from proven Texas bloodlines. Our chocolate fallow deer offer the consistent coloration, solid frames, and reliable temperaments that form the foundation of successful breeding operations across Texas."
      bulletPoints={[
