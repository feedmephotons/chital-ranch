...
const ChocolateFallowDeerForSaleTexas: React.FC = () => {
  return (
    <LandingPageTemplate
      ...
      intro="Looking for chocolate fallow deer for sale in Texas? CR Fallow offers quality breeding stock with consistent chocolate coloration, balanced frames, and healthy, steady temperaments. Our deer are raised in South Texas with close attention to genetics, health, and long-term quality."
      bulletPoints={[
      ...
      secondaryTitle="Why Choose CR Fallow?"
