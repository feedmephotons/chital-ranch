...
const FallowDeerGeneticsTexas: React.FC = () => {
  return (
    <LandingPageTemplate
      ...
      intro="Quality fallow deer genetics are the foundation of any successful breeding program. At Chital Ranch, our genetics come from respected Texas bloodlines — including contributions from some of the state's top programs — and we use those strengths to build a herd that is consistent, balanced, and reliable."
      bulletPoints={[
      ...
      calloutText="Every animal at Chital Ranch carries forward the qualities we work for every season — clean, healthy animals with predictable results."
    />
  );
};
